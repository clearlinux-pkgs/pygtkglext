...
Version  : 1.0.1
Release  : 3
URL      : http://downloads.sourceforge.net/gtkglext/pygtkglext-1.0.1.tar.gz
Source0  : http://downloads.sourceforge.net/gtkglext/pygtkglext-1.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1543754763
